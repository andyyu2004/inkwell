...
use llvm_sys::core::{
    LLVMAlignOf, LLVMArrayType, LLVMConstNull, LLVMFunctionType, LLVMGetElementType, LLVMGetTypeContext, LLVMGetUndef, LLVMPointerType, LLVMPrintTypeToString, LLVMSizeOf, LLVMTypeIsSized, LLVMVectorType
};
...
impl fmt::Debug for Type<'_> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        f.debug_struct("Type").field("address", &self.ty).field("llvm_type", &llvm_type).finish()
    }
}
